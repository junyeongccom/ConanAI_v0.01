  ...
  return (
    <>
      ...
      <section className="max-w-4xl mx-auto text-center py-20 px-4">
        <div className="bg-gradient-to-br from-[#1c2444]/80 to-[#111827]/80 border border-indigo-500/20 p-12 rounded-xl shadow-xl">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">
            지금 바로 체험해보세요
          </h2>
          <p className="text-lg text-gray-300 mb-8 leading-relaxed">
            복잡한 XBRL/DSD 작성 과정을 AI가 자동화합니다.<br />
            실무자의 시간을 절약하고 정확성을 높이는 솔루션을 경험해보세요.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/financial-dsd"
              className="inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              재무 DSD 체험하기
            </a>
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-3 border border-indigo-500 text-indigo-400 font-semibold rounded-lg hover:bg-indigo-500 hover:text-white transition-all duration-300"
            >
              문의하기
            </a>
          </div>
