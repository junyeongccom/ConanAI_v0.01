...
import { FaArrowLeft, FaLightbulb, FaSearch, FaTags } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          {categories.slice(1).map(category => (
            <div key={category} className="bg-white p-4 rounded-lg shadow-md text-center">
        ...
        <div className="space-y-6">
          {filteredConcepts.length === 0 ? (
            ...
            filteredConcepts.map((concept) => (
              <div key={concept.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="p-6">
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-green-500 rounded-lg p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            기본 개념을 이해했다면, Sky-C의 AI 기반 플랫폼으로 
            실제 IFRS S2 보고서를 작성해보세요.
          </p>
