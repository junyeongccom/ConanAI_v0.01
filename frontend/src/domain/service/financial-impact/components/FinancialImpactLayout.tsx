...
import { IndustryType, FinancialImpactInput, FinancialImpactResult } from '../models/types';
import { INDUSTRY_TYPES, SCENARIO_TYPES, MOCK_REGIONS } from '../models/constants';
