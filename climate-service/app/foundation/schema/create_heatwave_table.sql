...
CREATE TABLE IF NOT EXISTS heatwave_summary (
    ...
    scenario VARCHAR(50) NOT NULL COMMENT '기후 시나리오 (SSP1-2.6, SSP2-4.5, SSP3-7.0, SSP5-8.5)',
    region_name VARCHAR(100) NOT NULL COMMENT '지역명 (경기도, 전라남도 등)',
    year_period VARCHAR(10) NOT NULL COMMENT '연도구간 (2025, 2030, 2040, 2050)',
    heatwave_days REAL NOT NULL COMMENT '폭염일수 (평균값)',
    change_amount REAL COMMENT '변화량(일수) - 2025년 대비',
    change_rate REAL COMMENT '변화율(%) - 2025년 대비',
    baseline_value REAL COMMENT '기준값 (2025년 폭염일수)',
